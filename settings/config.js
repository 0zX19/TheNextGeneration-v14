module.exports = {
  ...
  embed: {
    ...
    wrongcolor: process.env.wrongcolor || "Red",
    footertext: "Powered By: Premier Crafty",
  },
  emoji: {
    ERROR: "❌",
    SUCCESS: "✅",
  ...
  links: {
    ...
    DiscordServer: process.env.DiscordServer || `https://discord.gg/xhd5kw4mkg`,
    VoteURL: process.env.VoteURL || `https://discord.gg/xhd5kw4mkg`,
    Website: `https://premiercrafty.site/`,
  },
  options: {
    embedFooter: true,
    nowplayingMsg: true,
