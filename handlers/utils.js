...
module.exports = async (client) => {
  ...
  client.queueembed = (guild) => {
    let embed = new EmbedBuilder()
      .setColor(client.config.embed.color)
      .setImage(`https://cdn.discordapp.com/attachments/1128313171627737179/1128314132379209829/tng_music.png`);
    return embed;
  };
  ...
  client.playembed = (guild) => {
    let embed = new EmbedBuilder()
      ...
      .setImage(`https://media.discordapp.net/attachments/1128313171627737179/1128317701228609556/Colorful_Modern_Japanese_Poster_832_467_piksel.png?width=748&height=420`)
      .setFooter({
        text: "I support Youtube, Spotify, Soundcloud and direct MP3 Links!",
      });
